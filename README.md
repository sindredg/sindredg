...
| [**Forest to Cloud: Cross-Region Hybrid Identity Infrastructure**](https://github.com/sindredg/two-site-hybrid-identity) |Two-site Active Directory forest in Azure, synchronised to Entra ID. Hybrid-joined endpoints and users, per-machine LAPS credentials, tiered privileged access enforced by policy, and private networks. Terraform and idempotent PowerShell throughout.  |Two-site Active Directory forest in Azure, synchronised to Entra ID. Hybrid-joined endpoints and users, per-machine LAPS credentials, tiered privileged access enforced by policy, and private networks. Terraform and idempotent PowerShell throughout. | Terraform · Azure · Entra ID · Active Directory · Windows Server · Group Policy · Windows LAPS · PowerShell · Entra Connect Sync · Github Actions |
