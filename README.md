...
| --- | --- | --- |
| [**Cloud Operations Lab on Azure Container Apps**](https://github.com/sindredg/container-app-in-azure) | Public container platform deployed with Terraform. Uses private image storage, managed-identity image pulls, health probes, revisions, scale-to-zero, remote state, and centralized logging. An internal API and scaling experiments are planned. | Terraform ·Docker · Nginx · Azure Container Apps · ACR · Managed Identity · Log Analytics |
