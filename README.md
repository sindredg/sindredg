...
| --- | --- | --- |
| [**GKE Kubernetes Platform**](https://github.com/sindredg/k8-lab) | **In progress.** A private GKE Standard cluster built with Terraform, featuring custom networking, Cloud NAT, DNS-only control-plane access, Dataplane V2, Workload Identity and node autoscaling. Kubernetes workloads and delivery automation are next. | Terraform · GCP · GKE · Kubernetes · VPC · Cloud NAT · Workload Identity |
