...
| In-progess.. [**Access Control & Identity Governance**](https://github.com/sindredg/Access-Control-and-Identity-Governance) | Governs access tenant wide and to in-house apps: tenant-wide Conditional Access, just-in-time admin access with PIM, and identity governance through entitlement management, access reviews, and lifecycle workflows. | Entra ID · Conditional Access · PIM · FIDO2 · Access Reviews · Lifecycle Workflows · Microsoft Graph PowerShell |
