...
| --- | --- | --- |
| [**Azure to GCP: Multi-Cloud Identity and Infrastructure**](https://github.com/sindredg/hybrid-cloud-infra-and-identities) | **In progress.** Extends the Azure-hosted AD DS and Entra ID environment into GCP. The deployed foundation provides protected Terraform state, cost controls and keyless GitHub OIDC; networking, human federation and cross-cloud connectivity follow in later phases. | Terraform · GCP · Azure · Entra ID · Workload Identity Federation · GitHub OIDC · IAM · Hybrid Networking |
