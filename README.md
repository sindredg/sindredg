...
| --- | --- | --- |
| [**Hybrid Identity: Active Directory to Entra ID**](https://github.com/sindredg/Hybrid-Identities-EntraID-and-AD) | Stands up an on-premises-style Active Directory forest in Azure and setup synchronisation to Entra ID: Project is In-progess. | Terraform · Azure · Active Directory · Windows Server · PowerShell ·  Entra ID · Entra Connect · |
